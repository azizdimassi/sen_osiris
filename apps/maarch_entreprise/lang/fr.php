...
if (!defined('_FOLDERTYPE_DELETION'))    define( '_FOLDERTYPE_DELETION', 'Type de dossier supprim&eacute;');
...
if (!defined('_CHOOSE_ADRESSE')) define( '_CHOOSE_ADRESSE', 'Choisissez une adresse');
if (!defined('_SITE')) define( '_SITE', 'Site');
if (!defined('_RAYONNAGE')) define( '_RAYONNAGE', 'Rayonnage');
if (!defined('_ALLEE')) define( '_ALLEE', 'All&eacute;e');
if (!defined('_NIVEAU')) define( '_NIVEAU', 'Niveau');
...
if (!defined('_DOCTYPE_MAIL')) define( '_DOCTYPE_MAIL', 'Type de document');
...
if (!defined('_INDEXING_MLB')) define( '_INDEXING_MLB', '[document] Enregistrer un document');
...
if (!defined('_MAIL_DATE')) define( '_MAIL_DATE', 'Date du document');
if (!defined('_NUMERO_BOITE')) define( '_NUMERO_BOITE', 'Num&eacute;ro de bo&icirc;te');
if (!defined('_ADRESSE_DE_RANGEMENT')) define( '_ADRESSE_DE_RANGEMENT', 'Adresse de rangement');
...
if (!defined('_IS_PRIVATE_CONTACT')) define( '_IS_PRIVATE_CONTACT', 'Contact privé');
...
if (!defined('_SHIPPER')) define( '_SHIPPER', 'Provenance');
...
if (!defined('_UPDATE_DOC_STATUS')) define( '_UPDATE_DOC_STATUS', 'Statut du document mis &agrave; jour');
