...
*/
    ...
    if ($core->test_service('add_links', 'apps', false)) {
        ...
        /* commentaire du bouton lier à un document
    ...
    $frmStr .= '<td style="width:200px;"><label for="category_id" '
            . 'class="form_title" style="display:none;">' . _CATEGORY . '</label></td>';
    ...
    $frmStr .= '<td class="indexing_field"><select name="category_id" '
            ...
            . 'index.php?display=true&page=get_content_js\');" style="display:none;">';
...
//     	//	}
//    //else{
//     	//$frmStr .= '<td><label class="form_title" >'
//     		//	. '<span id="exp_contact">' . _SHIPPER . '</span>'
//     			//		. '<span id="dest_contact">' . _DEST . '</span>';
//     //}
...
//     else{
//     	$frmStr .= '<td class="indexing_field"><input type="text" name="contact" '
//     			. 'id="contact" value="" /><div id="show_contacts" '
//     			. 'class=""></div></td>';
//     	$frmStr .='<script type="text/javascript"></script>';
//     }
//     $frmStr .= '<td><span class="red_asterisk" id="contact_mandatory" '
//             . 'style="display:inline;">*</span>&nbsp;</td>';
    $frmStr .= '</tr>';
    ...
    */
    ...
    $frmStr .= '</tr>';
    /*** Numero de boite ***/
    $frmStr .= '<tr id="numero_boite" style="display:' . $displayValue . ';">';
    $frmStr .= '<td><label for="numero_boite" class="form_title" '
    		. 'id="numero_boite" style="display:inline;" >' . _NUMERO_BOITE
    		. '</label></td>';
    $frmStr .= '<td>&nbsp;</td>';
    $frmStr .= '<td class="indexing_field"><input name="num_boite" type="text" '
    		. 'id="num_boite" value=""/></td>';
    $frmStr .= '</tr >';
    ...
    $frmStr .= '<tr id="category_tr" style="display:' . $displayValue . ';">';
    $frmStr .= '<td style="width:200px;"><label for="category_id" '
    		. 'class="form_title">' . _ADRESSE_DE_RANGEMENT. '</label></td>';
    $frmStr .= '<td style="width:10px;">&nbsp;</td>';
    $frmStr .= '<td class="indexing_field"><select name="category_id" '
    		. 'id="category_id" onchange="clear_error(\'frm_error_' . $actionId
    		. '\');change_category(this.options[this.selectedIndex].value, \''
    ...
    $frmStr .= '<option value="">' . _CHOOSE_ADRESSE. '</option>';
    $frmStr .= '<option value="">' . _SITE. '</option>';
    $frmStr .= '<option value="">' . _RAYONNAGE. '</option>';
    $frmStr .= '<option value="">' . _ALLEE. '</option>';
    $frmStr .= '<option value="">' . _NIVEAU. '</option>';
    $frmStr .= '</select></td>';
    $frmStr .= '</tr>';
    ...
    */
    ...
    if (count($actions) > 0) {
        $frmStr .= '<select name="chosen_action" id="chosen_action" style="display:none;">';
    ...
    if ($_SESSION['user']['UserId'] == 'superadmin') {
    	...
    	$frmStr .= '<input name="society" type="text"  id="society" value="default_value" />';
    	$frmStr .= '<span class="red_asterisk" id="society_mandatory" '
    			. 'style="display:inline;">*</span>';
        //$frmStr .='<script type="text/javascript">computeTotalAmount();</script>';
    }
    $frmStr .= '</td>';
    $frmStr .= '</tr>';
